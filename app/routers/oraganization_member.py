...
def get_organizaton_member(id:int,db:Session=Depends(get_db)):
...
def create_organization_member(member:schemas.OrganizationMemberCreate,db:Session=Depends(get_db)):
...
def update_organization_member(id:int,member:schemas.OrganizationMemberUpdate,db:Session=Depends(get_db)):
...
def update_organization_member(id:int,member:schemas.OrganizationMemberCreate,db:Session=Depends(get_db)):
...
def delete_organization_member(id:int,db:Session=Depends(get_db)):
